...
function PresentBoard({ data, showFullscreen }: { data: BoardData; showFullscreen: boolean }) {
  ...
  return (
    <main className="flex min-h-dvh flex-col overflow-x-hidden overflow-y-auto bg-[#333e3d] px-3 py-3 text-[#f4f1eb] sm:px-4 lg:h-dvh lg:min-h-0 lg:overflow-hidden">
              ...
              {employeeColumn.map(({ entry: { employee, assignment }, index }) => (
                ...
                >
                  ...
                  <div className="flex min-w-0 items-center px-2.5 py-1">
                    <p className={cn("break-words text-sm font-semibold leading-tight lg:truncate", !assignment && "text-[#9a9d9d]")}>
